...
void print_date(_time t){
  Serial.print("Hour: ");Serial.print(t.hour);Serial.print(":");Serial.print(t.minute);Serial.print(":");Serial.print(t.sec);
  Serial.print("  Date: ");Serial.print(t.day);Serial.print("/");Serial.print(t.month);Serial.print("/");Serial.print(t.year);Serial.println();
 }
...
void setup() {
  ...
  if (toggleFlag==1) {    //Write RTC     // 1st time it should contain garbage, so write RTC memory
    ...
    for (i = 0; i < bucket64.countrec; i++) {
      ...
      Serial.print("GT Temp: ");Serial.print(stats[0]);Serial.print("  ");print_date(time_temp_gt);
      Serial.print("LW Temp: ");Serial.print(stats[1]);Serial.print("  ");print_date(time_temp_lw);
      Serial.print("GT Humity: ");Serial.print(stats[2]);Serial.print("  ");print_date(time_hum_gt);
      Serial.print("LW Humity: ");Serial.print(stats[3]);Serial.print("  ");print_date(time_hum_lw);
      Serial.print("GT Light: ");Serial.print(stats[4]);Serial.print("  ");print_date(time_light_gt);
      Serial.print("LW Light: ");Serial.print(stats[5]);Serial.print("  ");print_date(time_light_lw);
